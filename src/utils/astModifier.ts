...
export class ASTModifier {
  ...
  deleteElement(spec: DeleteElementSpec): this {
    ...
    while (
      deleteStart > 0 &&
      (this.originalCode[deleteStart - 1] === ' ' || this.originalCode[deleteStart - 1] === '\t')
    ) {
      deleteStart--;
    }
   ...
   */
  private searchForElementToDelete(
    node: Parser.SyntaxNode,
