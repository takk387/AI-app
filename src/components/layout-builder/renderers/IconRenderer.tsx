 ...
 * IconRenderer
 *
 * Renders icons for the GenericComponentRenderer.
 * Supports:
 * - Named icons (Heroicons/Lucide mapping)
 * - Raw SVG paths
 * - Custom visuals (placeholders for logos/graphics)
 */
...
type Style = DetectedComponentEnhanced['style'];
...
export const IconRenderer: React.FC<IconRendererProps> = ({ content, style }) => {
