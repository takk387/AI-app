...
tools: [agent/runSubagent][read][edit][execute][search][todo][web][github-copilot][write][browse][global-search][agent][createSubagent][createAgent][createdirectory][createfile][createandruntasks][runtests]
---
